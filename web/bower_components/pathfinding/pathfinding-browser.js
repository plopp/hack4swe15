...
module.exports = {
   ...
   */
  euclidean: function(dx, dy, neighbor) {
      // console.log('euclidean', dx, dy, neighbor);
      return Math.sqrt(dx * dx + dy * dy) + 10.0 * neighbor.weight;
  },
    ...
    while (!openList.empty()) {
        ...
        for (i = 0, l = neighbors.length; i < l; ++i) {
            ...
            if (!neighbor.opened || ng < neighbor.g) {
                neighbor.g = ng;
                neighbor.h = neighbor.h || weight * heuristic(abs(x - endX), abs(y - endY), neighbor);
